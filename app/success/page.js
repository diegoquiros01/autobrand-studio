    ...
    <div style={{ minHeight:"100vh", background:D.bg, display:"flex", alignItems:"center", justifyContent:"center", padding:20 }}>
      <div style={{ background:D.bg2, border:"1px solid rgba(64,192,87,0.3)", borderRadius:20, padding:"48px 40px", maxWidth:480, width:"100%", textAlign:"center" }}>
        ...
        <button onClick={() => router.push("/generar")}
          style={{ width:"100%", padding:14, background:"linear-gradient(135deg,#7950F2,#4C6EF5)", color:"#fff", border:"none", borderRadius:10, fontSize:15, fontWeight:500, cursor:"pointer", marginBottom:10 }}>
          Empezar a generar →
        </button>
