...
import BrandCard from '../components/adn/BrandCard';
  ...
  return (
    <AppLayout>
      ...
      <div style={{ background: D.bg, minHeight: "calc(100vh - 64px)", paddingBottom: 100 }}>
        ...
        <div className="adn-dashboard" style={{ maxWidth: 1100, margin: "0 auto", padding: "32px 24px 0", display: "grid", gridTemplateColumns: "1fr 360px", gap: 28 }}>
                    ...
                    <div style={{ marginTop: 10 }}>
                      {showCustomCat ? (
                        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                          ...
                          <button onClick={() => { setShowCustomCat(false); setCustomCatInput(""); }} style={{ padding: "8px 10px", borderRadius: 8, border: "1px solid " + D.border, background: "transparent", color: D.text3, fontSize: 12, cursor: "pointer" }}>x</button>
                        </div>
                      ) : (
